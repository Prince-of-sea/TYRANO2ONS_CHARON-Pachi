...
def main():
	...
	#動画連番変換
	mov2PNG(Path(PATH_DICT['video'] / 'kin.webm'), 1280, 720)
	mov2PNG(Path(PATH_DICT['video'] / 'sakura.webm'), 1280, 720)
	mov2PNG(Path(PATH_DICT['video'] / 'rain1.webm'), 1280, 720)
	mov2PNG(Path(PATH_DICT['video'] / 'sakura2.webm'), 1280, 720)
	mov2PNG_zugara2(Path(PATH_DICT['video'] / 'zugara2.webm'))
